...
import {
  mockOpportunities, stageLabels, stageColors, stageBadgeColors,
  type Opportunity, type OpportunityStage,
} from '@/lib/mock-data';
import { cn } from '@/lib/utils';

const STAGES: OpportunityStage[] = ['nuevo', 'calificado', 'propuesta', 'negociacion', 'ganado', 'perdido'];
...
export default function OportunidadesPage() {
  ...
  const byStage = STAGES.reduce<Record<OpportunityStage, Opportunity[]>>((acc, stage) => {
    acc[stage] = mockOpportunities.filter((o) => o.stage === stage);
    return acc;
  ...
  return (
    <div className="flex h-full flex-col overflow-hidden">
      <Header
        ...
        subtitle={`${mockOpportunities.length} oportunidades · ${formatCurrencyLocal(totalValue)} en pipeline`}
