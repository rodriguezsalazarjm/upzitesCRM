...
export function FloatingActions() {
  ...
  const trackWhatsApp = () => {
    setTip(false);
    trackContact({ contact_method: "whatsapp", location: "floating_action" });
    fetch("/api/track-event", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({
        type: "whatsapp_click",
        element: "floating_whatsapp",
  ...
  return (
    <div className="fab" aria-label="Contacto rápido">
      ...
      <a
        ...
        onClick={() => trackContact({ contact_method: "email", location: "floating_action" })}
      >
